...
const GRANT_DOCS = [
  {
    doc: {
      ...
      pool_targets: ['Allies'],
      category: 'vm',
      amount_basis: 'vm_allies_pool',
      notes: 'Viral Mythology (CotC): pool of free Allies dots equal to total purchased Allies dots (CP + XP + free_mci) across all non-VM-granted Allies merits. VM-granted Allies excluded to prevent feedback loop. Allocation stored as free_vm on individual Allies merit instances.',
    },
