...
const GRANT_DOCS = [
  ...
  },
  {
    doc: {
      ...
      category: 'lk',
      amount_basis: 'rating_of_partner_merit',
      partner_merit_name: 'Library',
      notes: 'Lorekeeper: pool of free dots equal to purchased Library dots (CP + XP only, not free), distributable across Herd and Retainer. Allocation stored as free_lk on individual merit instances.',
    },
