...
describe('AC3 — feed handler resolves _feedChar via _charForSub(sub)', () => {
  it('_feedChar is declared via _charForSub(sub)', () => {
    expect(src).toContain('const _feedChar = _charForSub(sub)');
  });
