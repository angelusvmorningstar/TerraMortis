...
export function updPool() {
  ...
  if (!pi || !pi.attr) {
    ...
    // gdx-11 (#981, AC6): noWP pools (Blood Bond Resistance) never show the
    // WP +3 bonus segment — the WP spend there is the cost of attempting,
    // never a dice bonus. wpBonus/spend-line copy above already respect
    // pi.noWP; this display segment previously didn't.
