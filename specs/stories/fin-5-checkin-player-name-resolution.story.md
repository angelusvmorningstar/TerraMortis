...
> never-started). Implementing commit `65c2a271` ("fix(fin-5): admin attendance view falls back to
> character.player"), merged via `cfc9714f`, 2026-04-27; follow-up fix `9756d179`. No new code
> written this pass.
