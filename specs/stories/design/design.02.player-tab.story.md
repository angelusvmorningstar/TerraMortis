...
The Player tab is the heaviest CSS surface — it spans `editor.css` (~4700 lines) and `components.css`, covering panels 1-12 of the design system reference in `public/mockups/font-test.html`:
...
- Reference panels 1-12 in `public/mockups/font-test.html` as the visual spec throughout.
