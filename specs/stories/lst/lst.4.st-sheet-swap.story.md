...
The target layout is prototyped at `public/mockups/sheet-col1-mockup.html`. This is a static HTML prototype — do not copy it directly. The `suite/sheet.js` renderer is the live implementation. Use the mockup only as a visual reference if layout questions arise.
...
- **The mockup at `public/mockups/sheet-col1-mockup.html` is a prototype** — use it for visual reference only, do not copy its HTML into production code.
